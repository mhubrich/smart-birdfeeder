...
*   **Smart Image Alignment**: Uses dynamically injected `object-position` CSS to horizontally side-scroll the raw image crop automatically centering the detected motion.
